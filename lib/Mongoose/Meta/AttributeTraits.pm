...
{
  $Mongoose::Meta::AttributeTraits::VERSION = '0.13';
}

package Mongoose::Meta::Attribute::Trait::Binary;
{
  $Mongoose::Meta::Attribute::Trait::Binary::VERSION = '0.13';
}
use strict;
use Moose::Role;
...
{
  $Moose::Meta::Attribute::Custom::Trait::Binary::VERSION = '0.13';
}
...
{
  $Mongoose::Meta::Attribute::Trait::DoNotMongoSerialize::VERSION = '0.13';
}
use strict;
use Moose::Role;
...
{
  $Moose::Meta::Attribute::Custom::Trait::DoNotMongoSerialize::VERSION = '0.13';
}
...
{
  $Mongoose::Meta::Attribute::Trait::Raw::VERSION = '0.13';
}
    use strict;
    use Moose::Role;
}
...
{
  $Moose::Meta::Attribute::Custom::Trait::Raw::VERSION = '0.13';
}
