...
$Mongoose::Meta::AttributeTraits::VERSION = '0.25';
package Mongoose::Meta::Attribute::Trait::Binary;
$Mongoose::Meta::Attribute::Trait::Binary::VERSION = '0.25';
use strict;
use Moose::Role;
...
$Moose::Meta::Attribute::Custom::Trait::Binary::VERSION = '0.25';
...
$Mongoose::Meta::Attribute::Trait::DoNotMongoSerialize::VERSION = '0.25';
use strict;
use Moose::Role;
...
$Moose::Meta::Attribute::Custom::Trait::DoNotMongoSerialize::VERSION = '0.25';
...
$Mongoose::Meta::Attribute::Trait::Raw::VERSION = '0.25';
    use strict;
    use Moose::Role;
}
{
    package Moose::Meta::Attribute::Custom::Trait::Raw;
$Moose::Meta::Attribute::Custom::Trait::Raw::VERSION = '0.25';
