...
BEGIN {
  $Mongoose::Meta::AttributeTraits::VERSION = '0.05';
}

package Mongoose::Meta::Attribute::Trait::Binary;
BEGIN {
  $Mongoose::Meta::Attribute::Trait::Binary::VERSION = '0.05';
}
use strict;
use Moose::Role;
...
BEGIN {
  $Moose::Meta::Attribute::Custom::Trait::Binary::VERSION = '0.05';
}
...
BEGIN {
  $Mongoose::Meta::Attribute::Trait::DoNotSerialize::VERSION = '0.05';
}
use strict;
use Moose::Role;
...
BEGIN {
  $Moose::Meta::Attribute::Custom::Trait::DoNotSerialize::VERSION = '0.05';
}
...
BEGIN {
  $Mongoose::Meta::Attribute::Trait::Raw::VERSION = '0.05';
}
	use strict;
	use Moose::Role;
}
...
BEGIN {
  $Moose::Meta::Attribute::Custom::Trait::Raw::VERSION = '0.05';
}
